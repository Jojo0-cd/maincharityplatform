    ...
    <div className="flex flex-col gap-4 p-6 max-w-sm mx-auto border rounded-xl shadow-md bg-white text-black">
      ...
      {isModalOpen && (
        <CheckoutModal 
          ...
          ethAddress="0x6e84d13625bb8a98Ac4cc131901441721982241e" // Add your actual fallback ETH address here
          bnbAddress="0x6e84d13625bb8a98Ac4cc131901441721982241e" // Add your actual fallback BNB address here
          btcAddress="bc1q05tpud76f9x0z5783r5x59aa5t4xzpp3fwquqp" // Add your actual fallback BTC address here
